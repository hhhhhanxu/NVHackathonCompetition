...
def main():
    ...
    parser.add_argument('--model_path', type=str,
                        default='SwinIR/model_zoo/002_lightweightSR_DIV2K_s64w8_SwinIR-S_x2.pth')
    parser.add_argument('--folder_lq', type=str, default='SwinIR/testsets/Set5/LR_bicubic/X2', help='input low-quality test image folder')
    parser.add_argument('--folder_gt', type=str, default='SwinIR/testsets/Set5/HR', help='input ground-truth test image folder')
